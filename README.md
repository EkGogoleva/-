...
1. Ссылка на репозиторий на GitHub: https://github.com/ZF-1000/final_task
...
4. При решении данной задачи были выполнены последовательно сделанные коммиты: ![Увы.. что-то пошло не так](git_log.PNG)  